...
src_account = algokit_utils.get_account_from_mnemonic(
    "model print vapor toddler laugh knock rescue drum seed critic month frozen seek ceiling matrix kitchen brief dentist dwarf issue piece honey similar abandon bus"

)
receiver_wallet = algokit_utils.get_account_from_mnemonic(
    "// Passphrase of receiver" 
)
